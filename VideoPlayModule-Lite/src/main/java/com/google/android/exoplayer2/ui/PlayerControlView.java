...
public class PlayerControlView extends FrameLayout {
  ...
  private void updateProgress() {
    ...
    for (AnimUtils.UpdateProgressListener s : listenerCopyOnWriteArraySet){
      s.updateProgress(position, bufferedPosition,duration);
    }
  ...
  public boolean shouldShowPauseButton() {
    ...
    /***
     * Sets the {@link AnimUtils.UpdateProgressListener}.
     * 设置进度回调
     * @param updateProgressListener ProgressUpdateListener
     */
